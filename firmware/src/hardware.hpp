...
#define SV_R1 5060 //r1 value in the voltage divider ; 5k1 resistor with 1% tolerance, measured with multimeter
#define SV_R2 1320 //r2 value in the voltage divider ; 1k resistor and 330 resistor with 1% tolerance, measured with multimeter
